      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Liên hệ với chúng tôi để được hỗ trợ hoặc phản hồi
          </p>
        </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">
                    123 Đường Học Tập
                    <br />
                    Thành Phố Next.js, TP.HCM 70000
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-800">
                    <strong>Server Actions:</strong> Form này sử dụng Next.js
                    Server Actions để xử lý form, validation với Zod, và
